> Archived on 10 September 2026 after the user clarified the central role of energy exchange, clocks, asymmetry, and interacting observers. This earlier plan remains an optional prediction benchmark. Follow [the current roadmap](../NEXT-STEPS.md) for the active sequence. Links in the historical text below have been adjusted for its archive location.
